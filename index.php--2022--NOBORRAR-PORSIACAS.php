 ...
 * @todo - Some new CSV files use ; instead of tab as CSV field separator
 */
    ...
    function screen_year_month($year=0)
    {
        ...
        foreach ($this->a_csv as $key => $val) {
            ...
            if ($percent >= 55) {
                ...
                foreach ($a_temp as $k => $v) {
                    if ($i > 2) {
                        ...
                        if (strlen($v) > 5) {
                            ...
                            // BUG--Los nuevos CSV llevan ; en vez de TAB
                ...
                if ($debug) echo '<h3 style="color:red">- NOT_VALID_CSV='.$val.'</h3>';
            }
